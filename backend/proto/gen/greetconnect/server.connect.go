...
import (
	...
	context "context"
	errors "errors"
	clutch "github.com/vinewz/clutch"
	http "net/http"
	strings "strings"
)
...
type GreetServiceClient interface {
	Greet(context.Context, *connect.Request[clutch.GreetRequest]) (*connect.Response[clutch.GreetResponse], error)
}
...
func NewGreetServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) GreetServiceClient {
	...
	greetServiceMethods := clutch.File_server_proto.Services().ByName("GreetService").Methods()
	return &greetServiceClient{
		greet: connect.NewClient[clutch.GreetRequest, clutch.GreetResponse](
			httpClient,
...
type greetServiceClient struct {
	greet *connect.Client[clutch.GreetRequest, clutch.GreetResponse]
}

// Greet calls greet.v1.GreetService.Greet.
func (c *greetServiceClient) Greet(ctx context.Context, req *connect.Request[clutch.GreetRequest]) (*connect.Response[clutch.GreetResponse], error) {
...
func (UnimplementedGreetServiceHandler) Greet(context.Context, *connect.Request[clutch.GreetRequest]) (*connect.Response[clutch.GreetResponse], error) {
