...
package ipcprotoconnect

import (
	connect "connectrpc.com/connect"
	context "context"
	errors "errors"
	gen "github.com/vinewz/clutch/backend/ipc/gen"
	http "net/http"
	strings "strings"
)
...
const (
	...
	ToggleWindowServiceName = "ipc.proto.v1.ToggleWindowService"
)
...
const (
	...
	// ToggleWindow RPC.
	ToggleWindowServiceToggleWindowProcedure = "/ipc.proto.v1.ToggleWindowService/ToggleWindow"
)

// ToggleWindowServiceClient is a client for the ipc.proto.v1.ToggleWindowService service.
...
// NewToggleWindowServiceClient constructs a client for the ipc.proto.v1.ToggleWindowService
...
func NewToggleWindowServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) ToggleWindowServiceClient {
	...
	toggleWindowServiceMethods := gen.File_ipc_proto.Services().ByName("ToggleWindowService").Methods()
...
// ToggleWindow calls ipc.proto.v1.ToggleWindowService.ToggleWindow.
...
// ToggleWindowServiceHandler is an implementation of the ipc.proto.v1.ToggleWindowService service.
...
func NewToggleWindowServiceHandler(svc ToggleWindowServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/ipc.proto.v1.ToggleWindowService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedToggleWindowServiceHandler) ToggleWindow(context.Context, *connect.Request[gen.ToggleWindowRequest]) (*connect.Response[gen.ToggleWindowResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("ipc.proto.v1.ToggleWindowService.ToggleWindow is not implemented"))
}
