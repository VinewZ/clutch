...
const file_ipc_proto_rawDesc = "" +
	"\n" +
	"\tipc.proto\x12\fipc.proto.v1\"\x15\n" +
	"\x13ToggleWindowRequest\"\x16\n" +
	"\x14ToggleWindowResponse2n\n" +
	"\x13ToggleWindowService\x12W\n" +
	"\fToggleWindow\x12!.ipc.proto.v1.ToggleWindowRequest\x1a\".ipc.proto.v1.ToggleWindowResponse\"\x00B3Z1github.com/vinewz/clutch/backend/ipc/gen;ipcprotob\x06proto3"
...
var file_ipc_proto_goTypes = []any{
	(*ToggleWindowRequest)(nil),  // 0: ipc.proto.v1.ToggleWindowRequest
	(*ToggleWindowResponse)(nil), // 1: ipc.proto.v1.ToggleWindowResponse
}
var file_ipc_proto_depIdxs = []int32{
	0, // 0: ipc.proto.v1.ToggleWindowService.ToggleWindow:input_type -> ipc.proto.v1.ToggleWindowRequest
	1, // 1: ipc.proto.v1.ToggleWindowService.ToggleWindow:output_type -> ipc.proto.v1.ToggleWindowResponse
