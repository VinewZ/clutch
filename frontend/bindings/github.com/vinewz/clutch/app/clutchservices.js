 ...
 */
export function GetRPCServerPort() {
    let $resultPromise = /** @type {any} */($Call.ByID(3238203681));
    return $resultPromise;
}
...
/**
 * @param {$models.ClutchServices | null} services
 * @returns {Promise<application$0.Service[]> & { cancel(): void }}
 */
export function RegisterServices(services) {
    let $resultPromise = /** @type {any} */($Call.ByID(2243616331, services));
    let $typingPromise = /** @type {any} */($resultPromise.then(($result) => {
