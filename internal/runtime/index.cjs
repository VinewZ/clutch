...
let _clutch_compat_layer = require("@clutch/compat-layer");
...
const React$1 = _clutch_compat_layer.COMPAT.react;
...
const React = _clutch_compat_layer.COMPAT.react;
async function loadExtension(extensionPath, command) {
	...
	try {
		const moduleUrl = (0, node_url.pathToFileURL)(entryPath).href;
...
const reconciler = (0, react_reconciler.default)(hostConfig);
	...
	return {
		async connect() {
			return new Promise((resolve, reject) => {
				...
				socket = node_net.default.createConnection(config.socketPath);
...
const REWRITE_MAP = new Map([
	["@raycast/api", _clutch_compat_layer.COMPAT.API],
	["react", _clutch_compat_layer.COMPAT.react],
	["react/jsx-runtime", _clutch_compat_layer.COMPAT.react],
	["react/jsx-dev-runtime", _clutch_compat_layer.COMPAT.react]
]);
...
//#endregion
exports.REWRITE_MAP = REWRITE_MAP;
exports.clearExtensionContext = clearExtensionContext;
exports.clearExtensionHandlers = clearExtensionHandlers;
