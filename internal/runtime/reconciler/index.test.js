...
describe("Reconciler", () => {
    ...
    it("should create instance for nested elements", () => {
        const element = React.createElement("div", { id: "root" }, React.createElement("span", null, "child"));
        const renderer = createReconciler();
        const result = renderer.render(element);
        expect(result).not.toBeNull();
        expect(result?.type).toBe("div");
    ...
    it("should handle context provider", () => {
        ...
        const element = React.createElement(ctx.Provider, { value: { value: "provided" } }, React.createElement("div", null, "child"));
        const renderer = createReconciler();
        const result = renderer.render(element);
        expect(result).not.toBeNull();
    });
    it("should handle fragment", () => {
        const element = React.createElement(React.Fragment, null, React.createElement("span", null, "first"), React.createElement("span", null, "second"));
        const renderer = createReconciler();
        const result = renderer.render(element);
        expect(result).not.toBeNull();
    });
    it("should handle nested function components", () => {
        const Inner = ({ children }) => React.createElement("section", null, children);
        const Outer = () => React.createElement(Inner, null, React.createElement("p", null, "text"));
    ...
    it("should handle function component with props", () => {
        const Inner = ({ title }) => React.createElement("div", null, title);
    ...
    it("should handle deeply nested components", () => {
        ...
        const Middle = () => React.createElement("div", null, React.createElement(Leaf));
        const Root = () => React.createElement("section", null, React.createElement(Middle));
    ...
    it("should handle function receiving children directly", () => {
        ...
        const element = React.createElement(Container, null, React.createElement("span", null, "test"));
        const renderer = createReconciler();
        const result = renderer.render(element);
        expect(result).not.toBeNull();
        expect(result?.type).toBe("div");
